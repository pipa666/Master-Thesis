...
From methods
% Most of them were educational specialist from different sectors, ranging from Early Childhood Education, to k12, and Higher Education (Mostly relevant for RQ2)
Adapted CTS items
%\textbf{"I can immediately establish the equity that will give the solution of a problem"}   --> "\textbf{I can quickly construct the equation which would yield the solution to any problem"}

% This one was modified based on a previous work from Korkmaz, It was taken literally from the most similar item \textbf{I believe that I can easily catch the relation between the figures}" --> \textbf{" I believe that I can easily catch the relation between symbols and conceptual figures"}

%\textit{“My dream is an important factor when I perform many tasks”} So this could be used to improve "\textit{Dreaming causes my most important projects to come to light.}" 
...
%To estimate the network structure we follow the work Epskamp, who made a comprehensive contribution for network analysis in R environment by collecting the most commonly used methods in the \textit{bootnet} package .  \parencite*{epskamp_estimating_2018, epskamp_tutorial_2018}.  
